...
constexpr unsigned HALF_SCREEN_SIZE_X_WORLD(HALF_SCREEN_SIZE_X / PIXELS_PER_UNIT);
constexpr unsigned HALF_SCREEN_SIZE_Y_WORLD(HALF_SCREEN_SIZE_Y / PIXELS_PER_UNIT);
