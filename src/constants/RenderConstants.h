  ...
  {"kadijah",
    {
      ...
      {"arm-idle-nequip-left", {4, 2, 1}},
      {"arm-idle-lequip-left", {5, 2, 1}},
      {"arm-idle-requip-left", {6, 2, 1}},
      {"arm-idle-bequip-left", {7, 2, 1}},
      {"arm-idle-nequip-right", {4, 2, 1}},
      {"arm-idle-lequip-right", {6, 2, 1}},
      {"arm-idle-requip-right", {5, 2, 1}},
      {"arm-idle-bequip-right", {7, 2, 1}},
      ...
      {"arm-walk-nequip-left", {4, 3, 4}},
      {"arm-walk-lequip-left", {4, 3, 4}},
      {"arm-walk-requip-left", {4, 3, 4}},
      {"arm-walk-bequip-left", {4, 3, 4}},
      {"arm-walk-nequip-right", {4, 3, 4}},
      {"arm-walk-lequip-right", {4, 3, 4}},
      {"arm-walk-requip-right", {4, 3, 4}},
      {"arm-walk-bequip-right", {4, 3, 4}},
    }
  },
  {"kathryn",
    {
